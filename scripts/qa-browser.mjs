...
for (const vp of VIEWPORTS) {
  ...
  // più le due dei prodotti dell'allevamento; in home le card dei reparti sono
  // tre prezzi (mieli, api regine, nuclei) e quella della consegna non ne ha.
  for (const [url, attese] of [['/', 3], ['/miele/', 7]]) {
