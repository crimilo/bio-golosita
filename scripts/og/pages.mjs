...
export const copy = {
  ...
  miele: {
    ...
    sub: 'Cinque varietà di produzione propria, smielate a freddo nei nostri apiari.',
  ...
  'miele-millefiori-primaverile': {
    bg: 'miele_colazione',
    pos: '55% 50%',
    eyebrow: 'millefiori · primaverile',
    title: ['Miele Millefiori Primaverile'],
    sub: 'Raccolto a marzo e aprile: delicato e floreale, il primo miele della stagione.',
    chips: ['500 g € 5,00', '1 kg € 9,00', 'Raccolto marzo–aprile'],
    badge: 'da € 5,00 / 500 g',
  },
